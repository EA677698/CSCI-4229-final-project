...
GoldenGateBridge::GoldenGateBridge() {
    ...
    for(int i = 0; back_bottom_beam_l->get_position().z + i * beam_depth < beam_end; i++){
        flip_flop = !flip_flop;
        float beam_y = flip_flop ? back_top_beam_l->get_position().y : back_bottom_beam_l->get_position().y + back_bottom_beam_l->get_height() / 2;
        back_cross_beam_l->add_point({back_bottom_beam_l->get_position().x + back_bottom_beam_l->get_width() / 2, beam_y, back_bottom_beam_l->get_position().z + i * beam_depth});
    }
    ...
    back_top_beam_r->set_position(tower1_r->get_width() / 2 + 1 + (street1->get_width()), sidewalk1->get_height(), -120);
    ...
    back_bottom_beam_r->set_position(tower1_r->get_width() / 2 + 1 + (street1->get_width()), -back_top_beam_r->get_height() * 2, -120);
    ...
    for(int i = 0; back_bottom_beam_r->get_position().z + i * beam_depth < beam_end; i++){
        flip_flop = !flip_flop;
        float beam_y = flip_flop ? back_top_beam_r->get_position().y : back_bottom_beam_r->get_position().y + back_bottom_beam_r->get_height() / 2;
        back_cross_beam_r->add_point({back_bottom_beam_r->get_position().x + back_bottom_beam_r->get_width() / 2, beam_y, back_bottom_beam_r->get_position().z + i * beam_depth});
    }
    ...
    bottom_beam_l->set_position(-tower1_r->get_width() / 2 - 1, -top_beam_l->get_height() * 2, sidewalk1->get_depth() / 4);
    ...
    for(int i = 0; bottom_beam_l->get_position().z + i * beam_depth < beam_end; i++){
        flip_flop = !flip_flop;
        float beam_y = flip_flop ? top_beam_l->get_position().y : bottom_beam_l->get_position().y + bottom_beam_l->get_height() / 2;
        cross_beam_l->add_point({bottom_beam_l->get_position().x + bottom_beam_l->get_width() / 2, beam_y, bottom_beam_l->get_position().z + i * beam_depth});
    }
    ...
    top_beam_r->set_position(tower1_r->get_width() / 2 + 1 + (street1->get_width()), sidewalk1->get_height(), sidewalk1->get_depth() / 4);
    ...
    bottom_beam_r->set_position(tower1_r->get_width() / 2 + 1 + (street1->get_width()), -top_beam_r->get_height() * 2, sidewalk1->get_depth() / 4);
    ...
    for(int i = 0; bottom_beam_r->get_position().z + i * beam_depth < beam_end; i++){
        flip_flop = !flip_flop;
        float beam_y = flip_flop ? top_beam_r->get_position().y : bottom_beam_r->get_position().y + bottom_beam_r->get_height() / 2;
        cross_beam_r->add_point({bottom_beam_r->get_position().x + bottom_beam_r->get_width() / 2, beam_y, bottom_beam_r->get_position().z + i * beam_depth});
    }
    ...
    front_top_beam_l->set_position(-tower1_l->get_width() / 2 - 1, sidewalk1->get_height(), tower2_l_sidewalk->get_position().z + tower2_l_sidewalk->get_depth());
    ...
    front_bottom_beam_l->set_position(-tower1_l->get_width() / 2 - 1, -front_top_beam_l->get_height() * 2, tower2_l_sidewalk->get_position().z + tower2_l_sidewalk->get_depth());
    ...
    for(int i = 0; front_bottom_beam_l->get_position().z + i * beam_depth < beam_end; i++){
        flip_flop = !flip_flop;
        float beam_y = flip_flop ? front_top_beam_l->get_position().y : front_bottom_beam_l->get_position().y + front_bottom_beam_l->get_height() / 2;
        front_cross_beam_l->add_point({front_bottom_beam_l->get_position().x + front_bottom_beam_l->get_width() / 2, beam_y, front_bottom_beam_l->get_position().z + i * beam_depth});
    }
    ...
    front_top_beam_r->set_position(tower1_r->get_width() / 2 + 1 + (street1->get_width()), sidewalk1->get_height(), tower2_r_sidewalk->get_position().z + tower2_r_sidewalk->get_depth());
    ...
    front_bottom_beam_r->set_position(tower1_r->get_width() / 2 + 1 + (street1->get_width()), -front_top_beam_r->get_height() * 2, tower2_r_sidewalk->get_position().z + tower2_r_sidewalk->get_depth());
    ...
    for(int i = 0; front_bottom_beam_r->get_position().z + i * beam_depth < beam_end; i++){
        flip_flop = !flip_flop;
        float beam_y = flip_flop ? front_top_beam_r->get_position().y : front_bottom_beam_r->get_position().y + front_bottom_beam_r->get_height() / 2;
        front_cross_beam_r->add_point({front_bottom_beam_r->get_position().x + front_bottom_beam_r->get_width() / 2, beam_y, front_bottom_beam_r->get_position().z + i * beam_depth});
    }
    ...
    for(float i = 0; i<475; i += 2){
        ...
        main_cable2->add_point({tower1_r->get_position().x + tower1_r->get_width() / 2.0f, y_value, i + tower1_l->get_depth()});
        ...
        if(fmod(i + offset, 5) == 0) {
            ...
            middle_cable_l->add_point({-tower1_l->get_width() / 2.0f, top_beam_l->get_position().y, i + tower1_l->get_depth()});
            ...
            middle_cable_r->add_point({tower1_r->get_position().x + tower1_r->get_width() / 2.0f, y_value, i + tower1_l->get_depth()});
            middle_cable_r->add_point({tower1_r->get_position().x + tower1_r->get_width() / 2.0f, top_beam_r->get_position().y, i + tower1_l->get_depth()});
    ...
    for(float i = 120; i > 0; i -= 2){
        ...
        if(fmod(i + offset, 5) == 0) {
            ...
            end_middle_cable_l->add_point({-tower1_l->get_width() / 2.0f, top_beam_l->get_position().y, total_depth + i});
            ...
            end_middle_cable_r->add_point(
                    {tower1_r->get_position().x + tower1_r->get_width() / 2.0f, top_beam_r->get_position().y, total_depth + i});
