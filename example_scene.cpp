...
ExampleScene::ExampleScene() {
    ...
    water->set_position(540, 0, 0);
    water->disable_bounding_box();
    ...
    // Share a pair of light sources with 2 pairs of intersection lights
    auto *intersection_light1 = new IntersectionLight();
    intersection_light1->set_position(16, 0, -10);
    intersection_light1->enable_light(GREEN_LIGHT, GL_LIGHT1);
    ...
    intersection_light2->add_existing_light(GREEN_LIGHT, intersection_light1->get_enabled_light());
    ...
    intersection_light3->enable_light(RED_LIGHT, GL_LIGHT2);
    ...
    intersection_light4->add_existing_light(RED_LIGHT, intersection_light3->get_enabled_light());
    ...
    street_light1->enable_light(GL_LIGHT3);
    ...
    street_light4->add_existing_light(street_light1->get_enabled_light());
    ...
    street_light2->add_existing_light(street_light1->get_enabled_light());
    ...
    street_light5->add_existing_light(street_light1->get_enabled_light());
    ...
    street_light3->add_existing_light(street_light1->get_enabled_light());
    ...
    street_light6->add_existing_light(street_light1->get_enabled_light());
    ...
    auto *bench1 = new ParkBench();
    bench1->set_rotation(0, -90, 0);
    bench1->set_position(0, 1, 156);
    scene.add_object(bench1);

    auto *bench2 = new ParkBench();
    bench2->set_rotation(0, -90, 0);
    bench2->set_position(50, 1, 156);
    scene.add_object(bench2);

    auto *bench3 = new ParkBench();
    bench3->set_rotation(0, -90, 0);
    bench3->set_position(-50, 1, 156);
    scene.add_object(bench3);

    auto *bench4 = new ParkBench();
    bench4->set_position(-190, 1, -82);
    scene.add_object(bench4);

    auto *bench5 = new ParkBench();
    bench5->set_position(-240, 1, -82);
    scene.add_object(bench5);

    auto *bench6 = new ParkBench();
    bench6->set_position(-290, 1, -82);
    scene.add_object(bench6);

    auto *bench7 = new ParkBench();
    bench7->set_rotation(0, 90, 0);
    bench7->set_position(0, 1, -308);
    scene.add_object(bench7);

    auto *bench8 = new ParkBench();
    bench8->set_rotation(0, 90, 0);
    bench8->set_position(50, 1, -308);
    scene.add_object(bench8);

    auto *bench9 = new ParkBench();
    bench9->set_rotation(0, 90, 0);
    bench9->set_position(-50, 1, -308);
    scene.add_object(bench9);

    auto *bench10 = new ParkBench();
    bench10->set_rotation(0, 180, 0);
    bench10->set_position(190, 1, -82);
    scene.add_object(bench10);

    auto *bench11 = new ParkBench();
    bench11->set_rotation(0, 180, 0);
    bench11->set_position(240, 1, -82);
    scene.add_object(bench11);

    auto *bench12 = new ParkBench();
    bench12->set_rotation(0, 180, 0);
    bench12->set_position(290, 1, -82);
    scene.add_object(bench12);
